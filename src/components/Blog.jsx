...
import img2 from "../assets/img/doctor.jpg"
import img3 from "../assets/img/doctor.jpg"
import img4 from "../assets/img/doctor.jpg"
import img5 from "../assets/img/doctor.jpg"
import img6 from "../assets/img/doctor.jpg"
    ...
    <div className=' min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-24'>
       <div className=" flex flex-col items center lg:flex-row justify-between">
          <div>
             ...
             <p className="mt-2 text-center lg:text-start">
               Lorem ipsum dolor sit amet consectetur adipiscing elit. Quae, veniam?
            </p>
          </div>
       ...
       <div className="my-8">
          <div class="flex flex-wrap justify-center gap-5">
             <BlogCard  img={img1} headlines="Unravelig the Mysteries of Sleep" />
             <BlogCard  img={img2} headlines="The Heart-Healthy Diet " />
             <BlogCard  img={img3} headlines="Understanding Pediatries Vaccinations" />
